...
`/healthz` · `/openapi.yaml` · `/v1/models` · `/v1/aliases` · `/v1/chat/completions` · `/v1/images/generations` · `/v1/images/edits` · `/v1/videos/generations` · `/v1/audio/speech` · `/v1/modeldesk/run` · `/v1/artifacts/:id`
