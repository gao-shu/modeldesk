...
export const API_FORMATS: readonly ApiFormatDef[] = [
  ...
  },
  {
    ...
    apiRootPath: "/v1",
    apiActionPath: "/images/generations",
    suggestedModelId: "agnes-image-2.5-flash",
    modelOptions: [
    ...
    modelOptionLabels: {
      "agnes-image-2.5-flash": "agnes-image-2.5-flash（免费）",
  ...
  },
  {
    ...
    label: "OpenAI 兼容",
    hint: "OpenAI 形 /images/generations · 常用火山方舟 https://ark.cn-beijing.volces.com/api/v3（勿填 api.openai.com）",
    modality: "image",
    tier: "core",
    suggestedBaseUrl: "https://ark.cn-beijing.volces.com/api/v3",
    apiRootPath: "/api/v3",
  ...
  },
  {
    id: "video.grok",
    label: "Grok",
    hint: "xAI · api.x.ai/v1 · grok-imagine-video-1.5（多参考 / 1080p 仅 1.5）",
    modality: "video",
    tier: "core",
    suggestedBaseUrl: "https://api.x.ai/v1",
    apiRootPath: "/v1",
    ...
    modelOptionLabels: {
      "grok-imagine-video-1.5": "grok-imagine-video-1.5（官方）",
      "grok-video-1.5": "grok-video-1.5（中转）",
      "grok-image-video": "grok-image-video（中转；仅首帧/文生）",
      "grok-video-3": "grok-video-3（中转；仅首帧/文生）",
      "grok-video-3-10s": "grok-video-3-10s（中转；仅首帧/文生）",
    },
    fields: [
      {
        key: "duration",
      ...
      ASPECT_GROK_VIDEO,
      {
        ...
        hint: "官方 480p / 720p；1080p 仅型号名含 1.5",
      },
      {
  ...
  },
  {
    ...
    apiActionPath: "/videos",
    suggestedModelId: "MiniMax-H3",
    modelOptions: ["MiniMax-H3", "minimax_h3"],
    modelOptionLabels: {
      "MiniMax-H3": "MiniMax-H3（上游标准）",
      minimax_h3: "minimax_h3（中转别名）",
    },
    fields: [
      {
        key: "duration_sec",
      ...
      },
      {
        ...
        hint: "写入 ratio；非 adaptive 时推断 size",
      },
      {
        ...REFERENCE_IMAGE_PAIR,
        listKey: "reference_images",
        ...
        audioListMax: 3,
        audioOnlyInRefsMode: true,
        hint: "无=文生；首帧/首尾帧；多参→content[] role=reference_image（提示词用图片1、图片2…）；可选参考音频",
      },
    ],
  },
  {
