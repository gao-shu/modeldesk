...
function apiActionPathForFormat(apiFormatId: string): string | null {
  ...
  if (apiFormatId === "video.zhipu-cogvideox" || apiFormatId === "video.openai-generations") {
    return "/videos/generations";
  }
  if (apiFormatId === "video.openai-videos" || apiFormatId === "video.openai-compatible" || apiFormatId === "video.agnes") {
    return "/videos";
  }
